...
export function FiveElementsLegend() {
  return (
    <div className="w-full flex flex-row justify-between items-center px-5 py-2 text-[11px] font-medium text-gray-700 bg-transparent">
      ...
      <div className="flex items-center space-x-3 text-[11px] font-bold text-gray-800">
