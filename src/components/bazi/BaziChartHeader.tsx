...
export function BaziChartHeader({
  ...
  return (
    <div className="flex flex-row justify-between items-center px-5 py-2 border-b-[1.5px] border-[#3182ce] bg-transparent">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          ...
          <span className="mt-0.5 font-extrabold text-[9px] tracking-wider text-[#1b3b6f] uppercase">
            LỮ PHÚC
          </span>
        </div>
        ...
        <div className="leading-tight text-[#1b3b6f]">
          ...
          <div className="text-[11px] font-bold tracking-widest uppercase leading-tight mt-0.5 text-[#244a85]">
            CẢI VẬN BỔ KHUYẾT
          </div>
        </div>
      </div>
